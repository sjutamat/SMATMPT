...
<div id="main" role="main">
	...
	<div id="content">
		<section id="widget-grid" class="">
			<?php
				$_ui->start_track();
				$alert_success = UI::print_alert('<strong>Success</strong> The page has been added.', 'success', array(), true);
				$alert_danger = UI::print_alert('<strong>Success</strong> Opps!!!', 'danger', array('closebutton'=>false), true);
				$alert_options = UI::print_alert('<h4 class="alert-heading">Warning!</h4>
