		...
		<div class="well">
			...
			<table class="table table-striped table-forum">
				<thead>
                    <tr>
                        <th colspan="2">
                        	<a href="#ajax/forum.php"> Projects </a> > <a href="#ajax/forum-topic.php">Business Requirement Docs </a> > Nam quam nunc blandit vel
                        </th>
                    </tr>
                </thead>
				<tbody>
					...
					<tr>
                        <td class="text-center">
                        	<a href="#ajax/profile.php"><img alt="" src="img/flags/us.png"> &nbsp; 
					...
					<tr>
                        <td class="text-center">
                        	<a href="#ajax/profile.php"><img alt="" src="img/flags/es.png"> &nbsp; 
